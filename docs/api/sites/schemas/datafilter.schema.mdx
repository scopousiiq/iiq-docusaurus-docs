...
id: datafilter
title: "DataFilter"
description: "Filter condition for search/list operations. Based on C# `DataFilter` from `Spark.Shared.Models.DataFramework`. Supports both simple filters and nested filter groups."
sidebar_label: "DataFilter"
hide_title: true
hide_table_of_contents: true
schema: true
sample: {"Facet":"string","Ids":["3fa85f64-5717-4562-b3fc-2c963f66afa6"],"Values":["string"],"Op":"None","CustomFieldTypeId":"3fa85f64-5717-4562-b3fc-2c963f66afa6","ComplexEditorPath":"string","Items":[null]}
