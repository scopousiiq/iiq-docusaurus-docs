...
id: users-api
title: "Users API"
description: "The Users API provides access to user management in IncidentIQ. Search for users, manage profiles, handle authentication, and control account settings across your organization."
