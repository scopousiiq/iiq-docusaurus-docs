---
id: idsforfiltersetslistgetresponse
title: "IdsForFilterSetsListGetResponse"
description: "Response containing filter set matching results. Mirrors `ListGetResponse<IdsForFilterSetsResponse>`. Each item maps a filter set to the user IDs that matched its conditions."
sidebar_label: "IdsForFilterSetsListGetResponse"
hide_title: true
hide_table_of_contents: true
schema: true
sample: {"Items":[{"FilterSetId":"3fa85f64-5717-4562-b3fc-2c963f66afa6","MatchedIds":["3fa85f64-5717-4562-b3fc-2c963f66afa6"]}],"ItemCount":25,"Paging":{"TotalRows":54343,"PageCount":10869,"PageSize":5,"PageIndex":0},"UserToken":"3fa85f64-5717-4562-b3fc-2c963f66afa6","RequestDate":"2024-07-29T15:51:28.071Z","ExecutionTime":0,"StatusCode":200,"Message":"string","ErrorKey":"string","ServerName":"string","ProcessId":0,"OperationId":"string","Properties":{},"Metadata":{},"Errors":[{"Field":"string","Message":"string","Code":"string"}]}
...
<Heading
  ...
  children={"IdsForFilterSetsListGetResponse"}
>
</Heading>



Response containing filter set matching results. Mirrors `ListGetResponse<IdsForFilterSetsResponse>`. Each item maps a filter set to the user IDs that matched its conditions.
