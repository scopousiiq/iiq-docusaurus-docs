---
id: getuserbyemailrequest
title: "GetUserByEmailRequest"
description: "Request to find a user by email address. Mirrors `Spark.Shared.Models.Requests.GetUserByEmailRequest`."
sidebar_label: "GetUserByEmailRequest"
hide_title: true
hide_table_of_contents: true
schema: true
sample: {"EmailAddress":"demo@incidentiq.com"}
