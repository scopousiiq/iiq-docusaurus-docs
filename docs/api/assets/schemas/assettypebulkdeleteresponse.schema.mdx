---
id: assettypebulkdeleteresponse
title: "AssetTypeBulkDeleteResponse"
description: "ItemGetResponse envelope containing the identifier of the bulk delete operation result."
sidebar_label: "AssetTypeBulkDeleteResponse"
hide_title: true
...
<Heading
  ...
  children={"AssetTypeBulkDeleteResponse"}
>
</Heading>



ItemGetResponse envelope containing the identifier of the bulk delete operation result.
