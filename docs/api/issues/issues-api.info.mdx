...
id: issues-api
title: "Issues API"
description: "The Issues API provides access to issue and issue type management in IncidentIQ. Configure the problems that users can report when creating tickets, define issue type taxonomies, and manage issue visibility."
