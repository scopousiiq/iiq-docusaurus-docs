...
id: locations-api
title: "Locations API"
description: "The Locations API provides access to IncidentIQ's location hierarchy. Manage districts, schools, buildings, and rooms to organize users, assets, and tickets geographically."
