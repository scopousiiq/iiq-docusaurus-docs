---
id: itemgetresponse-guid
title: "ItemGetResponse_Guid"
description: "Response wrapper for a single GUID value (typically a job or operation ID)"
sidebar_label: "ItemGetResponse_Guid"
hide_title: true
...
<Heading
  ...
  children={"ItemGetResponse_Guid"}
>
</Heading>



Response wrapper for a single GUID value (typically a job or operation ID)
