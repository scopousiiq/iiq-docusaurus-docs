...
description: "Response from a bulk ticket operation, containing a job ID for tracking progress."
sidebar_label: "BulkOperationResponse"
hide_title: true
