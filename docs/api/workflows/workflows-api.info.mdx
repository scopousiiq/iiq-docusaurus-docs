...
id: workflows-api
title: "Workflows API"
description: "The Workflows API provides access to IncidentIQ's workflow engine. Configure ticket lifecycles, define status transitions, and automate your service management processes."
